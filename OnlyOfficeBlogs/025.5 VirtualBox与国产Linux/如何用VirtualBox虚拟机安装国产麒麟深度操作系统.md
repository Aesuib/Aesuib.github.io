...
虚拟机软件VirtualBox非常方便，只要真实主机自己能上网，那么默认的虚拟机就能直接自动连接互联网。需要确认配置的，是虚拟机和主机之间要能互相直接连通
...
在真实Windows主机上安装下载FileZilla服务器端软件，直接自带提供中文界面，向导式设置，即可开通下载上传的权限，让虚拟Linux系统可以向真实Windows主机传送文件
